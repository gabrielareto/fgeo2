...
ForestGEO tables may identify the same quadrats in different ways. A common combination is a CCRR code and a consecutive numerical index. The old CTFS / `fgeo` workflow converts between them through functions such as `quad.to.gxgy()`, `gxgy.to.index()`, `index.to.gxgy()`, and their dependencies.
